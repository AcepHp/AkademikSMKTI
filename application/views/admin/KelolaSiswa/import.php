            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Import Siswa</h1>
                        <div class="d-flex">
                            <a href="<?php echo site_url('DataSiswa/downloadTemplate'); ?>"
                        ...
                        <div class="card-body">
                            <form action="<?=base_url('Datasiswa/import')?>" enctype="multipart/form-data"
                                ...
                                <div class="form-group">
                                    <label for="upload_excel">Pilih file Excel untuk diimpor:</label>
                                    <input type="file" name="upload_excel" id="upload_excel" required
                                        class="form-control">
                                </div>
