            ...
            <div id="content">
                        ...
                        <div class="col-lg-12 mb-4">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <h1 class="h6 text-gray-800" style="text-align: center;">Data Materi
                                            </h1>
                                            <hr>
                                            <form action="<?php echo site_url('materi/tambah_materi_admin/'); ?>"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="kode_jurusan" name="kode_jurusan"
                                                        ...
                                                        <option value="<?= $j->kode_jurusan ?>"><?= $j->nama_jurusan ?>
                                                        </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" id="kode_tingkatan"
                                                        name="kode_tingkatan" required>
                                                        <option value="" disabled selected>Pilih tingkatan</option>
                                                        <?php foreach ($tingkatan as $t) : ?>
                                                        <option value="<?= $t->kode_tingkatan ?>">
                                                            <?= $t->nama_tingkatan ?></option>
                                                        <?php endforeach; ?>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" class="form-control" id="id_tahun"
                                                        name="id_tahun"
                ...
                function updateKelasOptions() {
                    ...
                    for (var i = 0; i < dataKelas.length; i++) {
                        if (dataKelas[i].kode_jurusan == selectedJurusan && dataKelas[i].kode_tingkatan ==
                            selectedTingkatan) {
                    ...
                    for (var i = 0; i < dataMapel.length; i++) {
                        if (dataMapel[i].kode_jurusan == selectedJurusan && dataMapel[i].kode_tingkatan ==
                            selectedTingkatan) {
                            var option = document.createElement('option');
