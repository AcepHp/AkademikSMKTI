...
<body id="page-top">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tabel Video Sekolah</h6>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:10%; text-align:center; vertical-align:center;">
                                                    ...
                                                    <a href="#" class="btn btn-sm btn-danger" title="Hapus"
                                                        onclick="Delete_Video('<?php echo $row->id_video; ?>')">
    ...
    <!-- Modal -->
    <?php foreach ($video->result() as $row): ?>
    <div class="modal fade" id="videoModal<?php echo $row->id_video; ?>" tabindex="-1" role="dialog"
        aria-labelledby="videoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm" style="max-width: 50%; width: 100%;" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="videoModalLabel" style="font-size: 1.25rem;">Detail
                        video - <?php echo $row->id_video; ?></h5>
                ...
                <div class="modal-body" style="font-size: 1rem;">
                    <table class="table table-bordered">
                        <tbody>
                            ...
                            <tr>
                                <th>Video</th>
                                <td><iframe width="100%" height="400" src="<?php echo $row->url; ?>" frameborder="0"
