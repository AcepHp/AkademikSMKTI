...
<body id="page-top">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Data Manajemen Sekolah</h1>
                            <div class="btn-group">
                                <a href="<?php echo site_url('Kelola_Dashboard/Manajemen/tambah_manajemen'); ?>"
                                    class="btn btn btn-success shadow-sm mr-2"><i
                                        class="fas fa-download fa-sm text-white-50"></i> Tambah Data Manajemen</a>
                            </div>
                        </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tabel Manajemen Sekolah</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="example" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align:center; vertical-align:center;"><img src="<?php echo $row->gambar ?>" alt="Gambar"
                                                        style="width: 80px; height: auto;"></td>
                                                <td><?php echo $row->created ?></td>
                                                <td style="width:10%; text-align:center; vertical-align:center;">
                                                    <a href="#" class="btn btn-sm btn-info" title="Detail"
                                                        data-toggle="modal"
                                                        data-target="#manajemenModal<?php echo $row->id_manajemen; ?>">
                                                        <i class="fas fa-eye"></i>
                                                    </a>
                                                    <a href="<?php echo site_url('Kelola_Dashboard/Manajemen/edit_manajemen/'.$row->id_manajemen); ?>"
                                                        class="btn btn-sm btn-warning" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-sm btn-danger" title="Hapus"
                                                        onclick="Delete_Manajemen('<?php echo $row->id_manajemen; ?>')">
    ...
    <!-- Modal -->
    <?php foreach ($manajemen->result() as $row): ?>
    <div class="modal fade" id="manajemenModal<?php echo $row->id_manajemen; ?>" tabindex="-1" role="dialog"
        aria-labelledby="manajemenModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm" style="max-width: 50%; width: 100%;" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="manajemenModalLabel" style="font-size: 1.25rem;">Detail
                        Manajemen - <?php echo $row->id_manajemen; ?></h5>
                ...
                <div class="modal-body" style="font-size: 1rem;">
                    <table class="table table-bordered">
                        <tbody>
                            <tr>
                                <th>No</th>
                                <td><?php echo $row->id_manajemen; ?></td>
                            </tr>
                            <tr>
                                <th>Nama</th>
                                <td><?php echo $row->nama; ?></td>
    ...
    function Delete_Manajemen(id) {
        Swal.fire({
            ...
            text: "Data manajemen akan dihapus dan tidak dapat dikembalikan!",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '<?=site_url("Kelola_Dashboard/Manajemen/delete_manajemen/") ?>' + id;
            }
        });
    }
    </script>
