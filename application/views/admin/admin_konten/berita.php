...
<body id="page-top">
                                    ...
                                    <table class="table table-bordered" id="example" class="display" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align:center; vertical-align:center;">Author</th>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:10%; text-align:center; vertical-align:center;">
                                                    ...
                                                    <a href="#" class="btn btn-sm btn-danger" title="Hapus"
                                                        onclick="Delete_Berita('<?php echo $row->id_berita; ?>')">
    ...
    <!-- Modal -->
    <?php foreach ($berita->result() as $row): ?>
    <div class="modal fade" id="beritaModal<?php echo $row->id_berita; ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" style="max-width: 50%; width: 100%;" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="beritaModalLabel" style="font-size: 1.25rem;">Detail
                        Berita - <?php echo $row->id_berita; ?></h5>
