...
<body id="page-top">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tabel acara</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="example" class="display" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align:center; vertical-align:center;">Tanggal Acara</th>
                                        ...
                                        <tbody>
                                            <?php $no = 1; ?>
                                            <?php foreach ($acara->result() as $row) : ?>
                                            <tr>
                                                ...
                                                <td style="width:10%; text-align:center; vertical-align:center;">
                                                    ...
                                                    <a href="#" class="btn btn-sm btn-danger" title="Hapus"
                                                        onclick="Delete_Acara('<?php echo $row->id_acara; ?>')">
    ...
    <!-- Modal -->
    <?php foreach ($acara->result() as $row): ?>
    <div class="modal fade" id="acaraModal<?php echo $row->id_acara; ?>" tabindex="-1" role="dialog"
        aria-labelledby="acaraModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm" style="max-width: 50%; width: 100%;" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="acaraModalLabel" style="font-size: 1.25rem;">Detail
                        acara - <?php echo $row->judul; ?></h5>
