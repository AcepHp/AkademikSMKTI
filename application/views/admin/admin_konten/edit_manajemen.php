                ...
                <div class="container-fluid">
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Edit Data Manajemen Sekolah</h1>
                        </div>
                    </div>
                    <div class="container mt-5">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" name="jabatan"
                                value="<?php echo $manajemen->jabatan; ?>"><?php echo $manajemen->jabatan; ?></textarea>
                        </div>
                        <div class="form-group">
                            <label for="gambar">Gambar Saat Ini:</label>
                            <img src="<?php echo $manajemen->gambar; ?>" alt="Gambar Saat Ini" width="150">
                        </div>
                        <div class="form-group">
