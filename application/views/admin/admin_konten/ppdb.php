...
<body id="page-top">
    ...
    <!-- Modal -->
    <?php foreach ($ppdb_admin->result() as $row): ?>
    <div class="modal fade" id="ppdbModal<?php echo $row->id_ppdb; ?>" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm" style="max-width: 50%; width: 100%;" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="ppdbModalLabel" style="font-size: 1.25rem;">Detail
                        Halaman PPDB - <?php echo $row->id_ppdb; ?></h5>
