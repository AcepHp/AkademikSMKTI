...
<body id="page-top">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:10%; text-align:center; vertical-align:center;">
                                                    ...
                                                    <a href="<?php echo site_url('Kelola_Dashboard/Galeri/edit_galeri/'.$row->id_galeri); ?>"
                                                        class="btn btn-sm btn-warning" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-sm btn-danger" title="Hapus"
                                                        onclick="Delete_Galeri('<?php echo $row->id_galeri; ?>')">
    ...
    <!-- Modal -->
    <?php foreach ($galeri->result() as $row): ?>
    <div class="modal fade" id="galeriModal<?php echo $row->id_galeri; ?>" tabindex="-1" role="dialog"
        aria-labelledby="galeriModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm" style="max-width: 50%; width: 100%;" role="document">
            <div class="modal-content">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="galeriModalLabel" style="font-size: 1.25rem;">Detail Foto</h5>
    ...
    function Delete_Galeri(id) {
        Swal.fire({
            ...
            text: "Data Galeriakan dihapus dan tidak dapat dikembalikan!",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                // Ganti URL di bawah ini dengan URL yang sesuai untuk menghapus galeri
                window.location.href = '<?=site_url("Kelola_Dashboard/Galeri/delete_galeri/") ?>' + id;
            }
        });
    }
    </script>
