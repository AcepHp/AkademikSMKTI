                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Kelola Akses Akun</h1>
                            <div class="btn-group">
                                <a href="<?php echo site_url('Akses/tambahakun'); ?>"
                                    class="btn btn btn-success shadow-sm mr-2"><i
                                        class="fas fa-download fa-sm text-white-50"></i> Tambah Akun</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tabel Kelola Akun</h6>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" id="example" class="display" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            <?php if($row->role !== 'Siswa' && $row->role !== 'Guru' ){?>
                                            <tr>
                                                ...
                                                <td style="width:10%; text-align: center; vertical-align: middle;">
                                                    ...
                                                    <a href="#" class="btn btn-sm btn-danger" title="Hapus"
                                                        onclick="Delete_Akun('<?php echo $row->id_users; ?>')">
    ...
    function Delete_Akun(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '<?=site_url("Akses/delete_akun/") ?>' + id;
            }
        });
    }
    </script>
