                        ...
                        <div class="col-lg-4 mb-4">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="card mb-4">
                                        <div class="card-body">
                                            <form action="<?php echo site_url('KelolaKelas/cari_data'); ?>" method="get">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="kode_jurusan" required>
                                                            ...
                                                            <?php foreach ($jurusan as $jurusan_item) : ?>
                                                                <option value="<?php echo $jurusan_item->kode_jurusan; ?>" <?php echo isset($_GET['kode_jurusan']) && $_GET['kode_jurusan'] == $jurusan_item->kode_jurusan ? 'selected' : ''; ?>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="kode_tingkatan" required>
                                                            ...
                                                            <?php foreach ($tingkatan as $tingkatan_item) : ?>
                                                                <option value="<?php echo $tingkatan_item->kode_tingkatan; ?>" <?php echo isset($_GET['kode_tingkatan']) && $_GET['kode_tingkatan'] == $tingkatan_item->kode_tingkatan ? 'selected' : ''; ?>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" id="id_kelas" name="id_kelas" required>
                                                            ...
                                                            <?php foreach ($kelas as $kelas_item) : ?>
                                                                <option value="<?php echo $kelas_item->id_kelas; ?>" <?php echo isset($_GET['id_kelas']) && $_GET['id_kelas'] == $kelas_item->id_kelas ? 'selected' : ''; ?>>
