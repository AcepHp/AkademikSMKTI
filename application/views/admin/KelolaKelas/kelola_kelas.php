...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Data Siswa Tahun Akademik
                            <?= $this->KelolaKelas_model->get_tahun_akademik_by_id($tahun_akademik_aktif_id) ?></h1>

                        <div class="d-flex">
                            <a href="<?php echo site_url('kelolakelas/tambah_siswa_kelas/' . $id_kelas . '/' . $kode_jurusan); ?>"
                                class="btn btn-primary" id="tambahDataSiswa">
                                <i class="fas fa-plus"></i> Tambah Data Siswa
                            </a>
                            <button type="button" class="btn btn-success ml-2" data-toggle="modal"
                                data-target="#modalNaikKelas" id="btnNaikKelas">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="text-align: center; vertical-align: middle;">
                                                            <button class="btn btn-primary btn-sm" data-toggle="modal"
                                                                data-target="#moveStudentModal<?php echo $s->NISN; ?>">
            ...
            <?php foreach ($siswa as $s) : ?>
            <!-- Modal -->
            <div class="modal fade" id="moveStudentModal<?php echo $s->NISN; ?>" tabindex="-1" role="dialog"
                aria-labelledby="moveStudentModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nisn" name="nisn"
                                        value="<?php echo $s->NISN; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="nama_lengkap">Nama</label>
                                    <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap"
                                        value="<?php echo $s->Nama_lengkap; ?>" readonly>
                                </div>
                                <!-- Display current class -->
                                <div class="form-group">
                                    <label for="kelas_sekarang">Kelas Sekarang</label>
                                    <input type="text" class="form-control" id="kelas_sekarang" name="kelas_sekarang"
                                        value="<?php echo $nama_kelas; ?>" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="id_kelas" required>
                                        <option value="">Pilih Kelas</option>
                                        <?php foreach ($kelas as $kelas_item) : ?>
                                        <?php if ($kelas_item->nama_kelas !== $nama_kelas) : ?>
                                        <option value="<?php echo $kelas_item->id_kelas; ?>">
                                            <?php echo $kelas_item->nama_kelas; ?>
                                        </option>
                                        <?php endif ?>
            ...
            <div class="modal fade" id="modalNaikKelas" tabindex="-1" role="dialog"
                aria-labelledby="modalNaikKelasLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="<?php echo base_url('kelolakelas/naik_kelas'); ?>" method="post"
                                id="naikKelasForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tingkatan" name="tingkatan">
                                        <option value="">Pilih Tingkatan</option>
                                        <?php foreach ($tingkatan as $tingkatan_item) : ?>
                                        <?php if ($tingkatan_item->kode_tingkatan != $_GET['kode_tingkatan']) : ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                            id="siswa_<?php echo $siswa_item->NISN; ?>" name="selected_siswa[]"
                                            value="<?php echo $siswa_item->NISN; ?>">
                                        <label class="custom-control-label"
                                            for="siswa_<?php echo $siswa_item->NISN; ?>"><?php echo $siswa_item->Nama_lengkap; ?></label>
                                    </div>
                                    <?php endforeach; ?>
                                </div>
