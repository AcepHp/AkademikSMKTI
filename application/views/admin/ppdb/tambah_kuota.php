                ...
                <div class="container-fluid">
                    <div class="container-fluid">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Tambah Data Kuota Pendaftaran</h1>
                        </div>
                    </div>

                    <div class="container mt-5">
                        <?php echo form_open_multipart('PPDB/prosestambahkuota'); ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="nama_jurusan" required>
                                ...
                                <?php echo '<option value="'.$jurusan_item->nama_jurusan.'"'.$selected.'>'.$jurusan_item->nama_jurusan.'</option>' ?>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
