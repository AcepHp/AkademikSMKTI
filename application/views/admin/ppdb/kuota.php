                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Kuota Pendaftaran</h1>
                            <div class="btn-group">
                                <a href="<?php echo site_url('PPDB/tambah_kuota'); ?>"
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-primary">Tabel Kuota Pendaftaran</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table class="table table-bordered" id="example" class="display" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="text-align: center; vertical-align: middle;">Program Keahlian
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:10%; text-align: center; vertical-align: middle;">
                                                    ...
                                                    <a href="<?php echo site_url('PPDB/edit_kuota/'.$row->id_kuota); ?>"
                                                        class="btn btn-sm btn-warning" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="#" class="btn btn-sm btn-danger" title="Hapus"
                                                        onclick="Delete_Kuota('<?php echo $row->id_kuota; ?>')">
