...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/pplg.css') ?>">
...
<body>
    ...
    <!-- Judul -->
    <div class="judul-dkv">
        <div class="judul mb-3">PROFIL JURUSAN PENGEMBANGAN PERANGKAT LUNAK DAN GAME</div>
                ...
                <div class="row g-3">
                    <div class="col d-flex flex-column justify-content-center align-items-center">
                        <div class="penjelasan mb-3">
                            ...
                            <div class="isi card-body" style="margin-top: -10px;">
                                <p class="isi-jdl card-text ">
