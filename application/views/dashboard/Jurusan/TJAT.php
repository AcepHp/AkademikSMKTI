...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/tjat.css') ?>">
...
<body>
    ...
    <div class="carousel-inner inner">
        <div class="carousel-item active">
            ...
            <div class="jdl-utama carousel-caption d-none d-md-block">
                <h1>TEKNIK JARINGAN AKSES DAN TELEKOMUNIKASI</h1>
            </div>
        </div>
    </div>
    ...
    <!-- Judul -->
    <div class="judul-dkv">
        <div class="judul mb-3">PROFIL JURUSAN TEKNIK JARINGAN AKSES DAN TELEKOMUNIKASI</div>
