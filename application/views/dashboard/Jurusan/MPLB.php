...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/mplb.css') ?>">
...
<body>
    ...
    <div class="carousel-inner inner">
        <div class="carousel-item active">
            ...
            <div class="jdl-utama carousel-caption d-none d-md-block">
                <h1>MANAJEMEN PERKANTORAN LAYANAN DAN BISNIS</h1>
            </div>
        </div>
    </div>
    ...
    <!-- Judul -->
    <div class="judul-dkv">
        <div class="judul mb-3">PROFIL JURUSAN MANAJEMEN PERKANTORAN LAYANAN DAN BISNIS</div>
