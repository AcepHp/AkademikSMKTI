                    ...
                    <div class="inner">
                        <div class="form-row">
                            <div class="form-holder form-holder-2 col-12 mb-3">
                                ...
                                <input type="number" class="form-control col-sm-10" id="nisn" name="nisn"
                                    style="width: 100%;">
                            </div>
                        </div>
                        <div class="form-row" style="display: flex;">
                            <div class="form-holder form-holder-2 col-12 mb-3" style="flex: 1; margin-right: 10px;">
                                ...
                                <input type="text" class="form-control col-sm-10" id="pilihan_satu" name="pilihan_satu">
                            </div>
                            <div class="form-holder form-holder-2 col-12 mb-3" style="flex: 1;">
                                <label for="pilihan_dua">Pilihan 2</label>
                                <input type="text" class="form-control col-sm-10" id="pilihan_dua" name="pilihan_dua">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-holder form-holder-2 col-12 mb-3">
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2 col-12 mb-3">
                                ...
                                <input type="text" class="form-control col-sm-10" id="Jenis_kelamin"
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2 col-12 mb-3">
                                ...
                                <input type="text" class="form-control col-sm-10" id="agama" name="agama"
                                    style="width: 100%;">
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="form-holder form-holder-2 col-12 mb-3">
                                ...
                                <input type="text" class="form-control col-sm-10" id="provinsi" name="provinsi"
                                    style="width: 100%;">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-holder form-holder-2 col-12 mb-3">
                                ...
                                <input type="text" class="form-control col-sm-10" id="kabupaten_kota"
                                    name="kabupaten_kota" style="width: 100%;">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-holder form-holder-2 col-12 mb-3">
                                <label for="kecamatan">Kecamatan</label>
                                <input type="text" class="form-control col-sm-10" id="kecamatan" name="kecamatan"
                                    style="width: 100%;">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-holder form-holder-2 col-12 mb-3">
                                ...
                                <input type="text" class="form-control col-sm-10" id="kelurahan_desa"
                                    name="kelurahan_desa" style="width: 100%;">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-holder form-holder-2 col-12 mb-3">
                                <label for="dusun_kampung">Dusun/Kampung</label>
                                <input type="text" class="form-control col-sm-10" id="dusun_kampung"
                                    name="dusun_kampung" style="width: 100%;">
                            </div>
                        </div>
                        <div class="form-row" style="display: flex;">
                            <div class="form-holder form-holder-2 col-12 mb-3" style="flex: 1; margin-right: 10px;">
