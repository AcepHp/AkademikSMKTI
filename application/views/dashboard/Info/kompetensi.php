...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/kompetensi.css') ?>">
...
<body>
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        ...
                        <li class="nav-item mx-2 dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="<?php echo site_url('Jurusan/Animasi'); ?>">Animasi</a></li>
                                <li><a class="dropdown-item" href="<?php echo site_url('Jurusan/DKV'); ?>">Desain Komunikasi Visual</a></li>
                                <li><a class="dropdown-item" href="<?php echo site_url('Jurusan/TKJT'); ?>">Teknik Komputer Jaringan dan Telekomunikasi</a>
                                </li>
                                <li><a class="dropdown-item" href="<?php echo site_url('Jurusan/TJAT'); ?>">Teknik Jaringan Akses dan Telekomunikasi</a></li>
                                <li><a class="dropdown-item" href="<?php echo site_url('Jurusan/PPLG'); ?>">Pemrograman Perangkat Lunak dan Game</a></li>
                                <li><a class="dropdown-item" href="<?php echo site_url('Jurusan/MPLB'); ?>">Manajemen Perkantoran Layanan dan Bisnis</a></li>
                                <li>
                                </li>
                            </ul>
                        </li>
    ...
    <!-- Kepsek -->
    <div class="keahlian">
        <div class="programText mb-5">Program Keahlian</div>
        <div class="program row">
            <div class="col mb-5">
                <img src="<?php echo base_url('assets/images/background.png') ?>" alt="jurusan">
                <div class="container">
                    <a href="<?php echo site_url('Jurusan/DKV'); ?>">Desain Komunikasi Visual</a>
                </div>
            </div>
            <div class="col order-2">
                <img src="<?php echo base_url('assets/images/background.png') ?>" alt="jurusan">
                <div class="container">
                    <a href="<?php echo site_url('Jurusan/PPLB'); ?>">Pemrograman Perangkat Lunak dan Game</a>
                </div>
            </div>
            <div class="col order-3">
                <img src="<?php echo base_url('assets/images/background.png') ?>" alt="jurusan">
                <div class="container">
                    <a href="<?php echo site_url('Jurusan/TKJT'); ?>">Teknik Komputer Jaringan dan Telekomunikasi</a>
                </div>
            </div>
            <div class="col order-4">
                <img src="<?php echo base_url('assets/images/background.png') ?>" alt="jurusan">
                <div class="container">
                    <a href="<?php echo site_url('Jurusan/TJAT'); ?>">Teknik Jaringan Akses dan Telekomunikasi</a>
                </div>
            </div>
            <div class="col order-5">
                <img src="<?php echo base_url('assets/images/background.png') ?>" alt="jurusan">
                <div class="container">
                    <a href="<?php echo site_url('Jurusan/MPLB'); ?>">Manajemen Perkantoran Layanan dan Bisnis</a>
                </div>
            </div>
            <div class="col order-6">
                <img src="<?php echo base_url('assets/images/background.png') ?>" alt="jurusan">
                <div class="container">
                    <a href="<?php echo site_url('Jurusan/Animasi'); ?>">Animasi</a>
                </div>
            </div>
        </div>
    </div>
