...
<body>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="jurusanDropdown">
                            ...
                            <a class="dropdown-item" href="#">PPLG</a>
                            <a class="dropdown-item" href="#">TKJT</a>
                            <a class="dropdown-item" href="#">TJAT</a>
                            <a class="dropdown-item" href="#">Animasi</a>
    ...
    <div class="container">
        <div class="ekskul">
            <div class="ekskulText">EKSTRAKULIKULER</div>
            <div class="Rectangle"></div>
            <div class="Sambutan">
                Asalamualikum warahmatullahi wabarakatuh<br>

                <br> Pergeseran era revolusi industri 4.0 ke society 5.0 semakin memantapkan eksistensi teknologi
                digital bagi kemaslahatan umat manusia. Era society 5.0 menitikberatkan optimalisasi teknologi digital
                bagi kenyamanan hidup manusia
                Kebutuhan tenaga kerja dalam industri digital di era industri 4.0 dan society 5.0 ini tentu akan semakin
                banyak, tidak hanya di bursa tenaga kerja domestik namun juga regional bahkan internasional. <br>
                SMK TI Garuda Nusantara Cimahi memiliki pilihan jurusan yang sangat relevan dengan kebutuhan tenaga
                kerja saat ini dan masa depan, dengan cakupan bidang profesi sebagai berikut: <br>
                1. Bidang Telekomunikasi, jurusan yang dapat dipilih, Teknik Jaringan Akses Telekomunikasi (TJAT) <br>
                2. Bidang Multimedia, jurusan yang dapat dipilih, Animasi atau Multimedia <br>
                3. Bidang Teknologi Informasi, jurusan yang dapat dipilih, Rekayasa Perangkat Lunak (RPL) atau Teknik
                Komputer Jaringan (TKJ) <br>
                4. Bidang Administrasi Perkantoran, jurusan yang dapat dipilih, Otomatisasi Tata Kelola Perkantoran
                (OTKP) <br>
                Para peserta didik pada jurusan-jurusan tersebut digembleng untuk beradaptasi dengan kemajuan teknologi,
                sehingga ketika lulus sekolah diharapkan mereka siap menghadapi dunia kerja di era society 5.0 ini. <br>
                <br> Wassalamualaikum Wr. Wb.
            </div>
            <img class="Foto" src="https://via.placeholder.com/400x400" alt="Foto Kepala Sekolah">
        </div>
    </div>
    <br><br><br>
    <br><br><br>
