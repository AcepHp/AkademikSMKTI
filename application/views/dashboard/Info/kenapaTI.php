...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('assets/css/whyti.css') ?>">
...
<body>
    ...
    <div class="carousel-inner inner mb-5">
        <div class="carousel-item active position-relative">
            <img src="<?php echo $info->gambar?>" class="d-block w-100" alt="...">
            <div class="jdl-utama carousel-caption text-center">
    ...
    <div class="container-fluid mb-5">
        <div class="row">
            <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                <div class="row">
                    <div class="sambut card">
                        <div class="isi card-body">
                            <h5 class="card-title">Assalamualaikum Warahmatullahi Wabarakatuh</h5>
                            <p class="card-text">
                                <?php echo $info->deskripsi ?><br><br>
                            </p>
                            <h5 class="card-title">Wassalamualaikum Warahmatullahi Wabarakatuh</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 d-flex flex-column justify-content-center align-items-center">
                <div class="Foto card">
                    <img src="<?php echo $info->gambar?>" class="img-fluid">
                </div>
            </div>
        </div>
    </div>

    <!-- <div class="fakta card text-center">
        <div class="card-body">
            <h5 class="card-title">Fakta SMK TI Garnus</h5>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras molestie nunc nec
                eros varius pharetra. Vivamus pharetra efficitur orci, at suscipit mauris gravida dignissim.</p>
        </div>
    </div>

    <div class="bungkus card text-center">
        <div class="card-body row">
            <div class="col-md-2">
                <p class="card-title">Tahun Berdiri</p>
                <h5 class="card-text">2009</h5>
            </div>
            <div class="col-md-2">
                <p class="card-title">Peserta Didik</p>
                <h5 class="card-text">1,400</h5>
            </div>
            <div class="col-md-2">
                <p class="card-title">Guru & Staff</p>
                <h5 class="card-text">150</h5>
            </div>
            <div class="col-md-2">
            ...
            <div class="col-md-2">
                <p class="card-title">Kompetensi Keahlian</p>
