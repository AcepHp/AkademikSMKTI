...
<body id="page-top">
    ...
    $(document).ready(function() {
        // Ketika halaman dimuat, periksa apakah ada data post sebelumnya untuk kode_tingkatan
        var selectedTingkatan =
        '<?php echo isset($_POST['kode_tingkatan']) ? $_POST['kode_tingkatan'] : ''; ?>';
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(key, value) {
                            dropdownTingkatan.append('<option value="' + key + '">' +
                                value + '</option>');
                        });
