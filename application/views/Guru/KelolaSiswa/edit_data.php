            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="d-flex">
                            <a href="<?php echo site_url('Guru/tambah_siswa'); ?>"
                    ...
                    <div class="container mt-5">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="kode_jurusan" required>
                                ...
                                <option value="<?php echo $jurusan_item->kode_jurusan; ?>"
                                    <?php if ($siswa_data->kode_jurusan == $jurusan_item->kode_jurusan) echo 'selected="selected"'; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_kelas" required>
                                ...
                                <option value="<?php echo $kelas_item->id_kelas; ?>"
                                    <?php if ($siswa_data->id_kelas == $kelas_item->id_kelas) echo 'selected="selected"'; ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="status"
                                value="<?php echo $siswa_data->Status; ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="tinggal_dengan"
                                value="<?php echo $siswa_data->Tinggal_dengan; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="nama_ayah">Nama Ayah:</label>
                            <input type="text" class="form-control" name="nama_ayah"
                                value="<?php echo $siswa_data->Nama_ayah; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="nama_ibu">Nama Ibu:</label>
                            <input type="text" class="form-control" name="nama_ibu"
                                value="<?php echo $siswa_data->Nama_ibu; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="nama_wali">Nama Wali:</label>
                            <input type="text" class="form-control" name="nama_wali"
                                value="<?php echo $siswa_data->Nama_wali; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="no_telp_ortu">No Telp Orang Tua:</label>
                            <input type="text" class="form-control" name="no_telp_ortu"
                                value="<?php echo $siswa_data->No_telp_ortu; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="no_telp_wali">No Telp Wali:</label>
                            <input type="text" class="form-control" name="no_telp_wali"
                                value="<?php echo $siswa_data->No_telp_wali; ?>" required>
                        </div>

                        <div class="form-group">
                            <label for="tahun_akademik">Tahun Akademik:</label>
                            <input type="text" class="form-control" name="tahun_akademik"
                                value="<?php echo $siswa_data->Tahun_akademik; ?>" required>
                        </div>
