            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> Tambah Data Tingkatan</h1>


                    </div>
                    <div class="container mt-5">
                        <?php echo form_open('Tingkatan/tambah_tingkatan'); ?>

                        <div class="form-group">
                            <label for="kode_tingkatan">Kode Tingkatan</label>
                            <input type="text" class="form-control" id="kode_tingkatan" name="kode_tingkatan" required>
                        </div>
                        <div class="form-group">
                            <label for="nama_tingkatan">Nama Tingkatan</label>
                            <input type="text" class="form-control" id="nama_tingkatan" name="nama_tingkatan" required>
                        </div>
